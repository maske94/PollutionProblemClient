...
class APIConstants {
    ...
    static final String ERROR_INVALID_FIELD_TIMESTAMP = "Field 'timeStamp' is not a valid ISO date format";
    ...
    static final String ERROR_MISSING_FIELD_DATE_START = "Missed mandatory \'dateStart\' field in the request";
    static final String ERROR_MISSING_FIELD_DATE_END =  "Missed mandatory \'dateEnd\' field in the request";
    static final String ERROR_INVALID_FIELD_DATE_START = "Field \'dateStart\' is not a valid ISO date format";
    static final String ERROR_INVALID_FIELD_DATE_END = "Field \'dateEnd\' is not a valid ISO date format";
